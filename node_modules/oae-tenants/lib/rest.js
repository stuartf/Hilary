...
var TenantExport = require('oae-tenants/lib/api.export');
...
/**
 * @REST getTenantExport
 *
 * Get a JSON representation of all the data in a tenant
 *
 * @Server      admin
 * @Method      GET
 * @Path        /tenant/export/{alias}
 * @Return      {TenantExport}              All the data for the tenant
 * @HttpResponse                200         Tenant data
 * @HttpResponse                500         Error exporting one or more modules
 */
OAE.globalAdminRouter.on('get', '/api/tenant/export/:alias', function(req, res) {
    TenantExport.exportAll(req.ctx, req.params.alias, function(err, data) {
        if (err) {
